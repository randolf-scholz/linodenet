...
from imtskit_special import spectral_norm, spectral_norm_native
from imtskit_special.compiled import spectral_norm as spectral_norm_cpp
from imtskit_special.fallbacks import spectral_norm as spectral_norm_py
from imtskit_special.fallbacks.spectral_norm import (
    State,
    _body_fn as body_fn,
    _cond_fn as cond_fn,
