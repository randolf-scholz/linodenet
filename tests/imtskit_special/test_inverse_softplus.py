...
from imtskit_special.fallbacks import inverse_softplus
...
class TestInverseSoftplus:
    def test_special_values(self, dtype: torch.dtype, device: str) -> None:
    ...
    def test_roundtrip_from_preimage(self, dtype: torch.dtype, device: str) -> None:
        match dtype:
            case torch.float32:
                lower = -12.0
                upper = 12.0
    ...
    def test_roundtrip_from_image(self, dtype: torch.dtype, device: str) -> None:
        match dtype:
            case torch.float32:
    ...
    def test_gradcheck(self, dtype: torch.dtype, device: str) -> None:
