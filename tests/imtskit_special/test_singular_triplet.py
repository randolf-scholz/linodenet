...
from imtskit_special import singular_triplet, singular_triplet_native
from imtskit_special.compiled import singular_triplet as singular_triplet_cpp
from imtskit_special.fallbacks import singular_triplet as singular_triplet_py
    ...
    def test_svd_rank_one(
        ...
        *,
        ...
        match self.SVD_METHODS[method]:
            ...
            case imtskit_special.singular_triplet:
                B = torch.from_numpy(matrix)
