r"""Tests for imtskit.surjections."""

import pytest
import torch

from imtskit.domains.matrix_tests import is_orthogonal, is_row_orthogonal
...
from imtskit.mappings.abstract import Surjection
