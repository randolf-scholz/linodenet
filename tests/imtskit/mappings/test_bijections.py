r"""Tests for imtskit.bijections."""

import pytest
import torch

from imtskit.domains import MATRIX_TESTS, MatrixDomains, ScalarDomains
from imtskit.mappings import (
    Bijection,
    PositiveDiagonal,
    PositiveScalarMatrix,
)
from imtskit.mappings.transforms import SmoothSoftsign, Tanh
