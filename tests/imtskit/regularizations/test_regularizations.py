r"""Tests for imtskit.regularizations."""

import pytest

from imtskit.regularizations import REGULARIZATION_FNS, REGULARIZATIONS
...
def test_modular(projection_name: str) -> None:
    assert camel2snake(projection_name) in REGULARIZATION_FNS
