r"""Custom operators for the imtskit package."""
...
# constants
_LIB_NAME: Final[str] = "libimtskit_special"
r"""The name of the custom library."""
_LIB: Final[ModuleType] = torch.ops.imtskit_special
...
_COMPILE_ENV_VAR: Final[str] = "IMTSKIT_SPECIAL_COMPILE"
...
def _load_prebuilt() -> KnownFunctions:
    ...
    resource = files("imtskit_special").joinpath(f"{_LIB_NAME}.so")
...
def _compile_lib_imtskit() -> KnownFunctions:
    try:
    ...
    raise RuntimeError(
        "Could not load custom binaries. Reinstall imtskit_special or set "
...
RAW_KERNELS: Final[KnownFunctions] = _compile_lib_imtskit()
# fmt: off
