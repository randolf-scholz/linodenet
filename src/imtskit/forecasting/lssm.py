...
class EncoderDecoderLSSM[State](nn.Module):
    ...
    | Component                                         | Formula              |
    +===================================================+======================+
    | Filter  $F$ (default: :class:`torch.nn.GRUCell`) | $x̂ᵢ' = F(x̂ᵢ, xᵢ)$     |
    +--------------------------------------------------+-----------------------+
    | Encoder $ϕ$ (default: :class:`iResNet`)          | $ẑᵢ' = ϕ(x̂ᵢ')$        |
    +--------------------------------------------------+-----------------------+
    | System  $S$ (default: :class:`LinODECell`)       | $ẑᵢ₊₁ = S(ẑᵢ', Δ tᵢ)$ |
    +--------------------------------------------------+-----------------------+
    | Decoder $π$ (default: :class:`iResNet`)          | $x̂ᵢ₊₁ = π(ẑᵢ₊₁)$      |
    +--------------------------------------------------+-----------------------+
    """
