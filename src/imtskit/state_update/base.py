r"""Different state-update models to be used in conjunction with imtskit.
...
from imtskit.nn import ModuleSequence
from imtskit.nn.rezero import resolve_gate
from imtskit.testing.utils import get_device
