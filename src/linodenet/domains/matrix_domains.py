...
MatrixDomains.KNOWN_SUPERTYPES = MappingProxyType({
    ...
    M.DOUBLY_CENTERED: frozenset({M.ROW_CENTERED, M.COLUMN_CENTERED}),
    ...
    M.LOW_RANK_SKEW_SYMMETRIC: frozenset({M.LOW_RANK_SQUARE, M.SKEW_SYMMETRIC}),
    M.LOW_RANK_SQUARE: frozenset({M.LOW_RANK, M.SQUARE}),
    M.LOW_RANK_SYMMETRIC: frozenset({M.LOW_RANK_SQUARE, M.SYMMETRIC}),
