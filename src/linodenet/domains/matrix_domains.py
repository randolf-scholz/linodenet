...
MatrixDomains.KNOWN_MEETS = (
    (M.NONE, frozenset({M.CONTRACTION, M.SPECTRAL_NORMALIZED})),
    (M.NONE, frozenset({M.INVERTIBLE, M.SINGULAR})),
    (M.NONE, frozenset({M.NEGATIVE_DEFINITE, M.POSITIVE_DEFINITE})),
    (M.NONE, frozenset({M.NEGATIVE_DEFINITE, M.POSITIVE_SEMIDEFINITE})),
    ...
    (M.ZERO, frozenset({M.DIAGONAL, M.ZERO_DIAGONAL})),
    ...
    (M.EYE, frozenset({M.DIAGONAL, M.PERMUTATION})),
    (M.DIAGONAL, frozenset({M.LOWER_TRIANGULAR, M.UPPER_TRIANGULAR})),
    (M.CHOLESKY_FACTOR, frozenset({M.LOWER_INVERTIBLE, M.POSITIVE_DIAGONAL_ENTRIES})),
