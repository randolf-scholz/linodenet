...
class EncoderDecoderLSSM[State](nn.Module):
    ...
    | Component                                         | Formula                    |
    +===================================================+============================+
    | Filter  $F$ (default: :class:`~torch.nn.GRUCell`) | $\hat xᵢ' = F(x̂ᵢ, xᵢ)$     |
    +---------------------------------------------------+----------------------------+
    | Encoder $ϕ$ (default: :class:`~iResNet`)          | $\hat zᵢ' = ϕ(x̂ᵢ')$        |
    +---------------------------------------------------+----------------------------+
    | System  $S$ (default: :class:`~LinODECell`)       | $\hat zᵢ₊₁ = S(ẑᵢ', Δ tᵢ)$ |
    +---------------------------------------------------+----------------------------+
    | Decoder $π$ (default: :class:`~iResNet`)          | $\hat xᵢ₊₁ = π(ẑᵢ₊₁)$      |
    +---------------------------------------------------+----------------------------+
    """
