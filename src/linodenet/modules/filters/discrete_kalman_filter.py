...
class DiscreteKalmanFilter(nn.Module):
    ...
    - Supports batched inference: leading batch dims *B are preserved.
    - System matrices F, H, Q, R, B can b learned.
    - You can pass time-varying F/H/Q/R/B per step to override the defaults.
    - Works on CPU or GPU; tensors follow the device/dtype of the provided arguments.
    """
    ...
    def forward(
        ...
        Args:
            ...
            hx: Initial hidden state (num_layers, *B, hidden_size)
