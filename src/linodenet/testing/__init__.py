...
MATRIX_TESTS: dict[MatrixDomains, MatrixTest | MatrixTestWithArgs] = {
    ...
    MatrixDomains.COLUMN_ORTHOGONAL    : is_column_orthogonal,
    MatrixDomains.SPECTRAL_NORMALIZED  : is_spectral_normalized,
    MatrixDomains.LEFT_INVERTIBLE      : is_left_invertible,
    ...
    MatrixDomains.RIGHT_INVERTIBLE     : is_right_invertible,
    MatrixDomains.ROW_ORTHOGONAL       : is_row_orthogonal,
