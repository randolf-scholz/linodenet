...
if __name__=="__main__":
    ...
    if FILTER_TYPE==1:
        ...
        nonlinear_filter_hp = NonLinearFilter.HP | {"num_blocks":6}
        HP["Filter"]["layers"] = [LinearFilter.HP, nonlinear_filter_hp, nonlinear_filter_hp]
   ...
   # }
    ...
    for fold,(train_index, test_index) in enumerate(rs.split(data_t)):
        ...
        writer.add_hparams({'hp':str(HP|args.__dict__)},{'train_loss': np.mean(train_losses), 'test loss':last_test_loss})
